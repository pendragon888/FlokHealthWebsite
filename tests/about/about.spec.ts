...
test.describe("Visit About page for Flok Health", ()=>{
    ...
    test('Validate About page present', async ({ aboutPage, page}) => {
        ...
        await expect(page.locator('body')).toContainText('I’m always looking for better ways to reach people, to support them earlier, and remove the barriers that keep them from thriving. Kirsty HendersonFlok Health Physiotherapist');
    })
})